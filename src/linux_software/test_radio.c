...
void print_benchmark(volatile unsigned int *periph_base)
{
    ...
    float time_spent = (float)elapsed_cycles / 125000000.0f;

    float throughput = ((float)bytes_transferred / (1024.0f * 1024.0f)) / time_spent;
...
// first, get a pointer to the peripheral base address using /dev/mem and the function mmap
    ...
    printf("\r\n\r\n\r\nLab 6 Caroline Hagen - Custom Peripheral Demonstration\n\r");
